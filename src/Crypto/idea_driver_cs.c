 ...
 * ****************************************************/
void stripCrypt_idea(char * ikey, MemPtr str, MemPtr out, int sLen, int enc)
{
       ...
       for(;offset<sLen;)
       {
           MemMove(ivector, str+offset, BLOCK_idea);
           //if(enc)
                Idea_Crypt(ivector, ovector, ekey);
           //else
           //     Idea_Crypt(ivector, ovector, dkey);

           MemMove(out+offset, ovector, BLOCK_idea);
           offset+=BLOCK_idea;
       }  
