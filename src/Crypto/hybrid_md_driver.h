...
#ifndef HYBRID_MD_DRIVER_H
#define HYBRID_MD_DRIVER_H 

/* total lenght is 288 bits, or 36 bytes */
#define HYBRID_DIGESTSIZE 36

void hybrid_md_string(char *, byte *);
void hybrid_md_block(byte *, int , byte *);
